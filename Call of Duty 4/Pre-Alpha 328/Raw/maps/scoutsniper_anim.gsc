...
//	level.scr_anim[ "price" ][ "wave_idle" ]					= %scout_sniper_price_wave_idle;
	...
	level.scr_anim[ "generic" ][ "cellphone_react" ]			= %exposed_idle_twitch_v4;
	level.scr_anim[ "generic" ][ "smoke_react" ]				= %exposed_idle_twitch_v4;
	level.scr_anim[ "generic" ][ "lean_smoke_react" ]			= %exposed_idle_twitch_v4;
