...
//radio_dialogue("launchfacility_a_recon_enemies_coming");
	...
	-------------------------*/
	level.launchfacility_a_price_ropenag_MAX = 5;
...
script_models()
{
	...
	level.scr_anim[ "player_rope" ][ "rappel_for_player_start" ]			= %launchfacility_a_setup_2_rappel_1_100ft_rope;
	level.scr_anim[ "player_rope" ][ "rappel_idle_for_player" ][0]	= %launchfacility_a_rappel_idle_2_100ft_rope;
	...
	level.scr_model[ "player_rope" ] 							= "rappelrope100_ri";
	...
	level.scr_anim[ "rope" ]["rappel_setup_to_stand_2"]			= %launchfacility_a_setup_2_rappel_1_100ft_rope;
