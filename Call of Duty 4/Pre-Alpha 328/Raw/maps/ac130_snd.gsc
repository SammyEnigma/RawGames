...
main()
{
	...
	level.scr_sound["nav"]["ac130_nav_600meters"] 			= "ac130_nav_600meters";
	...
	// TEMP - WILL GET REPLACED WITH NEW LINES FROM THE LINEBOOK THAT AREN'T RECORDED YET
	...
	Copy.								ac130_fco_copy4
	That's an affirmative.				ac130_plt_thatsaffirm
	Roger that.							ac130_fco_rogerthat2
	Affirmative.						ac130_plt_affirm
	
	Any more personnel in the area?																	ac130_plt_anymore
	Scanning, standby.																				ac130_fco_scanning
	Hold up and look around here. I know there?s a few guys, I saw them flying apart.				ac130_fco_holduplook
	You can run but you can't hide.																	ac130_fco_youcanrun
	Yeah but they're only gonna die tired.															ac130_fco_dietired
	(chuckling) check these guys out...I haven't seen anyone run this fast since the Olympics?		ac130_fco_runthisfast
